...
| **Context files** | `/home/kienct/.config/opencode/context/` |
...
| **New context** | `/home/kienct/.config/opencode/context/{category}/{name}.md` |
...
```
/home/kienct/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/kienct/.config/opencode/context/core/standards/code-quality.md`
- `/home/kienct/.config/opencode/context/ui/web/react-patterns.md`
- `/home/kienct/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/kienct/.config/opencode/context/{category}/

# All context
find /home/kienct/.config/opencode/context -name "*.md"
```
