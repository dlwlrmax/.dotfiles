...
/home/kienct/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/kienct/.config/opencode/context/{category}
...
```bash
cat > /home/kienct/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/kienct/.config/opencode/context/{category}/
...
Loads: `/home/kienct/.config/opencode/context/ui/web/react-patterns.md`
