...
├── .cache/
│   ├── test-coverage.md (cached from /home/kienct/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/home/kienct/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /home/kienct/.config/opencode/context/
ELSE:
  READ from /home/kienct/.config/opencode/context/
  CACHE the file
```
