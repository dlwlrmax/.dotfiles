...
- Answer is in `/home/kienct/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/home/kienct/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/home/kienct/.config/opencode/context/core/workflows/task-delegation-basics.md`
