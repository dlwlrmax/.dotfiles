...
```bash
npx ts-node /home/kienct/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/kienct/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
