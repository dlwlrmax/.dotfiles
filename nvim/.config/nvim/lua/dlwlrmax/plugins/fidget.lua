local set, fidget = pcall(require, 'fidget')

fidget.setup({
  text = {
    spinner = "dots_bounce",        -- animation shown when tasks are ongoing
  ...
  fmt = {
    ...
    task = -- function to format each task line
        function(task_name, message, percentage)
          ...
          if task_name == 'Resolving code actions' then return nil end
