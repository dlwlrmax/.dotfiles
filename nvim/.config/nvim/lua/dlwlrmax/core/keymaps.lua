...
--Format
api.nvim_set_keymap('n', '<leader>nf', '<ESC><cmd>lua vim.lsp.buf.format({ timeout_ms = 2000 })<CR>', { noremap = true })
-- api.nvim_set_keymap('v', '<leader>nf', '<ESC><cmd>lua vim.lsp.buf.format({ timeout_ms = 2000 })<CR>', {noremap = true})
