...
hl.window_rule({
    match = { class = "^(nemo|org.qbittorrent.qBittorrent|git-cola|vesktop|steam|org.kde.dolphin|org.kde.audiotube|thunar|Thunar|org.gnome.Nautilus)$" },
    float = true,
})
...
hl.window_rule({
    ...
    content = "video",
    monitor = 1,
    move    = "monitor_w-530 monitor_h-450",
})
